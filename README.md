...
[`browser.min.js`](browser.min.js) is only **1039 bytes**.
...
I demonstrated in practice that HMAC-MD5 can be implemented in an extremely small footprint (1039 bytes) while also improving reliability.
