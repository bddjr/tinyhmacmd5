...
[`browser.min.js`](browser.min.js) is only **1019 bytes**.
...
I demonstrated in practice that HMAC-MD5 can be implemented in an extremely small footprint (1019 bytes) while also improving reliability.
