 ...
 */
declare var md5: {
    (data: string | Uint8Array | Uint8ClampedArray, key?: string | Uint8Array | Uint8ClampedArray | null, raw?: false): string;
    (data: string | Uint8Array | Uint8ClampedArray, key: string | Uint8Array | Uint8ClampedArray | null | undefined, raw: true): Uint8Array<ArrayBuffer>;
};
export default md5;
